...
def _build_query(result: EngineResult, question: str) -> list[str]:
    tokens: list[str] = []
...
def retrieve(result: EngineResult, question: str, top_k: int = 2) -> list[str]:
    """Return top_k theory chunks most relevant to the position and question."""
    query = _build_query(result, question)
